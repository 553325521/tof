						...
						<div class="row">
							...
							<div class="col-md-2">
								<div class="row">
									...
									<div class="col-md-12">
										<a class="btn btn-primary"  role="button" data-toggle="modal" data-target="#myModal" id="askQuestion">我要提问</a>
										<!-- Modal -->
										  ...
										  <div class="modal-dialog " role="document">
										    <div class="modal-content">
										      <div class="modal-header">
										        ...
										        <h4 class="modal-title" id="myModalLabel" ><span style="color:#337ab7" class="glyphicon glyphicon-question-sign" aria-hidden="true"></span>我要提问</h4>
										      </div>
										          ...
										          <div class="row">
										          	<div class="col-md-12">
														  ...
														  <div class="form-group">
														    ...
														    <input type="text" class="form-control" id="title" placeholder="问题主要内容">
														  </div>
														  <div class="form-group">
														  	 <h6>内容:</h6>
							...
							<div class="col-md-10">
								<div class="row">
									...
									<div class="col-md-12" style="background:url(<%=path%>/img/title.gif)">
										<span class="glyphicon glyphicon-chevron-right"></span><span id="titleSpan">问题列表
										</span>
									</div>
									<div class="col-md-12">
...
<script>
	$(function(){
		 ...
		 $("#finish").click(function(){
				...
				$.post("<%=path%>/questionController/addTeacherQuestion",{"qTitle":title,"qContent":content},function(data){
					if(data.resultType == "1"){
						var opt = {
						        url: "<%=path%>/questionController/getQuestionData1",
						        silent: true,
						        query:{
						            type:1,
						           state:0,
		 ...
		 $('#problemTable').bootstrapTable({
		    ...
		    columns:[{  
		        ...
		        formatter:function(value,row,index){
		        	return "<span class='glyphicon glyphicon-heart-empty heart' aria-hidden='true'></span>&nbsp;<a href='<%=path%>/showStudentToTeacherDetail?qId="+row.qId+"'>"+value+"</a>";
		        }
		    },{  
		        field: 'qTimeStr',  
		        title: '提问时间' ,
