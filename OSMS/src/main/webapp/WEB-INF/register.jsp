...
<meta charset="utf-8">
<style>
	.registerTitle{border:1px lightgray solid}
	.registerContent{border:1px lightgray solid}
</style>
			 					...
			 					<form id="registerForm" class="form-horizontal">
									  <div class="form-group">
									    <label for="uNumber" class="col-sm-3 control-label">学号:</label>
									     <div class="col-sm-9">
									    	<input type="text" class="form-control" id="uNumber" name="uNumber" placeholder="请输入学号">
									  	 </div>
									  </div>
									  <div class="form-group">
									  ...
									  <div class="form-group">
									    ...
									    <div class="col-sm-9">
									    	<input type="password" class="form-control" id="pwdConfirm" name="pwdConfirm" placeholder="再次输入密码">
									  	</div>
									  </div>
									  <div class="form-group">
