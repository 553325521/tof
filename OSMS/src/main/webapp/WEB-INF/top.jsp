...
<html lang="zh-CN">
	<head>
		...
		<title>OS教育平台</title>
		<style type="text/css">
			.top1{background: url(<%=path%>/img/topbg.png) repeat-x;height: 40px;line-height: 40px;margin: auto;}
			.top2{background: #F5F5F3}
			.top2 .search{margin-top: 5%;}
			.last-problem{border:1px lightgray solid;height: 50px}
			.new{margin-top: 1%}
			.clear{height: 10px}
			.separate{height: 2px;border: 2px gray solid}
			.table-area{background: white}
			.top5{background:lightgray}
			.download-icon{background: #2ebb96;border-radius: 50%;}
			.top6{background: black;height: 50px;}
			.top6 p{color: white}
		</style>
		<!-- css文件 -->
		...
		<div class="container">
			<div class="top">
				...
				<div class="modal fade msg" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" style="z-index:1300">
