	...
	var $ = "undefined" != typeof window ? window : {},
		...
		Q = {
			...
			cropEnd : function(i) {
				if (!this.disabled) {
					...
					, e && (i.preventDefault(), E(a).length || (this.action = ""), this.cropping && (this.cropping = !1, this.$dragBox.toggleClass("cropper-modal", this.cropped && this.options.modal)), this.trigger("cropend", {
						originalEvent : n,
						action : e
					}))
				}
		...
		G = function() {
			function i(e) {
				...
				if (M(this, i), !e || !X.test(e.tagName))
					...
					value : function(t) {
						...
						if (t) {
							...
							if (a.checkOrientation && window.ArrayBuffer)
								if (H.test(t))
									Y.test(t) ? this.read(w(t)) : this.clone();else {
